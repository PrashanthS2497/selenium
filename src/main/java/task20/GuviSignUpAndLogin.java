...
public class GuviSignUpAndLogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//FullName
		driver.findElement(By.id("name")).sendKeys("Prashanth S");
		...
		//enter email id
		driver.findElement(By.id("email")).sendKeys("prashanths2497@gmail.com");
		
		//enter password
		driver.findElement(By.id("password")).sendKeys("Prashanthkumarspn@9");
