...
public class PhpTravels {
	...
	public static void main(String[] args) throws IOException {
		...
		//Business Name
		driver.findElement(By.name("business_name")).sendKeys("AAAA");
		
		//Email
		driver.findElement(By.name("email")).sendKeys("Prash@gmail.com");
		...
		File destination= new File("C:\\Users\\prash\\eclipse-workspace\\Screenshot\\FormSubmit.jpeg");
